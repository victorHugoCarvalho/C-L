...
$queryResult = mysql_query($query) or die("Erro ao enviar a query de sele&ccedil;&atilde;o");  
...
while ($row = mysql_fetch_row($queryResult)) // para cada cenario do projeto 
{    
	...
	<?php  
        ...
        $queryResult2 = mysql_query($query) or die("Erro ao enviar a query de selecao");  
    
    while ($row_2=mysql_fetch_row($queryResult2))
    {  
...
$queryResult = mysql_query($query) or die("Erro ao enviar a query de sele&ccedil;&atilde;o");  
while ($row=mysql_fetch_row($queryResult))   // para cada lexico do projeto
{ 
    ?>  
...
<?php  
    ...
    $queryResult = mysql_query($query) or die("Erro ao enviar a query de sele&ccedil;&atilde;o");  
    while ($row=mysql_fetch_row($queryResult))  // para cada conceito do projeto 
    {   
...
<?php  
    ...
    while ($row=mysql_fetch_row($queryResult))   // para cada rela��o do projeto 
    {    
...
<?php  
   ...
   while ($row=mysql_fetch_row($queryResult))  // para cada axioma do projeto 
   {  
