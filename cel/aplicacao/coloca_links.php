...
function divide_array( &$vet, $inicio, $fim, $tipo )
{
    $i = $inicio;
    $j = $fim;
    $dir = 1;
...
function quicksort( &$vetor, $inicio, $fim, $tipo )
{
    if ($inicio < $fim)
    {
            $k = divide_array( $vetor, $inicio, $fim, $tipo );
            quicksort( $vetor, $inicio, $k-1, $tipo );
            quicksort( $vetor, $k+1, $fim, $tipo );
    }
    else
    {
    	//Nothing to do.
